...
EC2는 이후 EBS, Security Group, ELB, Auto Scaling의 기반이므로 여기서는 유제와 3문장 요약을 진행한다.
...
5. ENI를 독립적인 네트워크 카드로 이해하면 어떤 점이 편해지는가?
...
EBS와 Security Group을 배운 뒤 이 EC2를 다시 확장한다.
